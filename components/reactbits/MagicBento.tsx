...
const DEFAULT_GLOW_COLOR = '230, 169, 62';
...
export const ParticleCard: React.FC<{
  ...
  }, [animateParticles, clearAllParticles, disableAnimations, enableTilt, enableMagnetism, clickEffect, glowColor, maxTilt, magnetStrength]);
